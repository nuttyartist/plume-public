...
void NoteListDelegateEditor::resizeEvent(QResizeEvent *event)
{
    ...
    if (m_delegate->isInAllNotes()) {
        ...
        m_tagListView->setGeometry(NoteListConstant::leftOffsetX - 5, y + 10, rect().width() - 26,
        ...
        m_tagListView->setGeometry(NoteListConstant::leftOffsetX - 5, y + 1, rect().width() - 26,
                                   m_tagListView->height());
    }
    recalculateSize();
}
...
void NoteListDelegateEditor::setTheme(Theme::Value theme)
{
    ...
    case Theme::Light: {
        ...
        m_contentColor = QColor(32, 36, 40);
